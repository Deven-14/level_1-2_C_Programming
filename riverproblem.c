...
{
    int j,k,m,t_crs,p,r1=0,r2=0; //r1- first hobbit of pair,r2- second hobbit of pair
    create_pairs(t2,p1);
    for(j=0;j<6;j++)
    {
        ...
        for(k=0;k<3;k++)
        {
            ...
            put_back_3_hob_to_check_all_cases(p,i,n,t,t2); // add the 3 hobbits back to try for different time values
